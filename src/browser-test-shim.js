...
System.config({
  ...
  map: {
    ...
    '@angular/common/testing': 'components/npm/@angular/common/bundles/common-testing.umd.js',
    '@angular/compiler/testing': 'components/npm/@angular/compiler/bundles/compiler-testing.umd.js',
    '@angular/platform-browser/testing': 'components/npm/@angular/platform-browser/bundles/platform-browser-testing.umd.js',
    '@angular/platform-browser-dynamic/testing': 'components/npm/@angular/platform-browser-dynamic/bundles/platform-browser-dynamic-testing.umd.js',
    '@angular/http/testing': 'components/npm/@angular/http/bundles/http-testing.umd.js',
    '@angular/router/testing': 'components/npm/@angular/router/bundles/router-testing.umd.js',
    '@angular/forms/testing': 'components/npm/@angular/forms/bundles/forms-testing.umd.js',
  },
});
